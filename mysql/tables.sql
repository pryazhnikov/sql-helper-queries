...
SELECT REGEXP_REPLACE(TABLE_NAME, "_?[0-9]+$", "") AS TABLE_NAMES_PREFIX,
    COUNT(*) AS TABLES_COUNT,
    SUM(TABLE_ROWS) AS TOTAL_ROWS_COUNT,
    ROUND(AVG(TABLE_ROWS)) AS AVG_ROWS_COUNT,
    MAX(TABLE_ROWS) AS MAX_ROWS_COUNT,
...
-- Table group prefix detection at MySQL before 8.0
